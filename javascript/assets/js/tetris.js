...
let tetrisMusic = new Audio("../assets/audio/BGM Tetris.mp3");
let tetrisMatchMusic = new Audio("../assets/audio/mario.wav");
let tetrisEndMusic = new Audio("../assets/audio/yea.mp3");
...
function tetrisGameover() {
  ...
  resultScore.innerText = tetrisTime + tetrisScore * 10;
}
...
const tetrisWrap1 = document.querySelector(".tetris__wrap");
const tetrisClose = document.querySelector(".tetris__close__btn");
tetrisIcon.addEventListener("click", () => {
  tetrisWrap1.classList.toggle("show");
});
tetrisClose.addEventListener("click", () => {
  tetrisWrap1.classList.remove("show");
});
